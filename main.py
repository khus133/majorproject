...
def create_text_card(text, title = "Response"):
    ...
    .card:hover {{
    box_shadow: 0 8px 16px 0 rgba(0,0,0,0.2);
    }}
    .container {{
    padding: 2px 16px;
    }}
...
def auto_play_audio(audio_file):
    ...
    base64_audio = base64(audio_bytes).decode("utf-8")
    audio_html = f'<audio src = "data:audio/mp3;base64,{base64_audio}" conttrols autoplay>'
